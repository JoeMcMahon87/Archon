...
If age > 1800 seconds (30 min): warn the user and recommend running `meridian-validate-sdaf` first.
...
Read the current task context from `.meridian/specs/*/tasks.md` to determine the most specific tag.
...
If no scan data: `Evidence: no scan data (run meridian-validate-sdaf before checkpoint)`
