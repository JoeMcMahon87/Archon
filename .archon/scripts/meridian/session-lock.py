#!/usr/bin/env python3
"""Session coordination for parallel meridian-cli sessions.
...
State file: .meridian/active-work.json (project-local, created on first use)
"""
import argparse
import json
import re
...
def find_state_file():
    return Path.cwd() / ".meridian" / "active-work.json"
...
def main():
    parser = argparse.ArgumentParser(description="Session coordination for parallel meridian-cli work")
